...
public class MarkServingActivity implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    private static final Gson GSON = new Gson();
    private final SessionComponent sessionComponent;

    public MarkServingActivity() {
        this.sessionComponent = ServiceInjector.getInstance(SessionComponent.class);
    }

    @Inject
    public MarkServingActivity(SessionComponent sessionComponent) {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent event, Context context) {
        ...
        boolean success = sessionComponent.markServing(sessionId);
