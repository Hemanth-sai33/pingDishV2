...
public class WebSocketDisconnectActivity implements RequestHandler<APIGatewayV2WebSocketEvent, APIGatewayV2WebSocketResponse> {
    private final WebSocketComponent wsComponent;

    public WebSocketDisconnectActivity() {
        this.wsComponent = ServiceInjector.getInstance(WebSocketComponent.class);
    }

    @Inject
    public WebSocketDisconnectActivity(WebSocketComponent wsComponent) {
    ...
    public APIGatewayV2WebSocketResponse handleRequest(APIGatewayV2WebSocketEvent event, Context context) {
        ...
        wsComponent.onDisconnect(connectionId);
